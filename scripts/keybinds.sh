...
EXEC_LABELS = [
    ...
    (r'wpctl set-volume.*5%\+',     'Volume Up'),
    (r'wpctl set-volume.*5%-',      'Volume Down'),
    (r'wpctl set-mute.*SINK.*toggle','Toggle Mute'),
    (r'wpctl set-mute.*SOURCE.*toggle','Toggle Mic'),
    (r'brightnessctl s 5%\+',       'Brightness Up'),
    (r'brightnessctl s 5%-',        'Brightness Down'),
    (r'kbd_backlight',              'Toggle KB Backlight'),
