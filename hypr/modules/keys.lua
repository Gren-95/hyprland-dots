...
hl.bind(mod .. " + F",            hl.dsp.window.fullscreen_state(1))
...
------------------------------------------------------------
hl.bind(mod .. " + KP_Add",         hl.dsp.window.resize("20 20"))
hl.bind(mod .. " + SHIFT + right",  hl.dsp.window.resize("20 0"),  { repeating = true })
hl.bind(mod .. " + SHIFT + down",   hl.dsp.window.resize("0 20"),  { repeating = true })
hl.bind(mod .. " + KP_Subtract",    hl.dsp.window.resize("-20 -20"))
hl.bind(mod .. " + SHIFT + left",   hl.dsp.window.resize("-20 0"), { repeating = true })
hl.bind(mod .. " + SHIFT + up",     hl.dsp.window.resize("0 -20"), { repeating = true })
